...
public class JdbcUtils {
    ...
    public static int executeUpdate(String sql) {
        try {
            return executor.executeUpdate(sql, null);
        } catch (Exception e) {
     ...
     * @return
     */
    public static <T> T executeQueryForObject(String sql, Class<T> resultType) {
        return executeQueryForObject(sql, null, resultType);
    }
     ...
     * @return
     */
    public static <T> List<T> executeQueryForList(String sql, Class<T> resultType) {
        return executeQueryForList(sql, null, resultType);
    }
